...
products = {
    ...
    'cite_shirt': {'name': 'CITE SHIRT', 'price': 450, 'image': 'BSIT.jpg'},
    'dept_shirt.html': {'name': 'DEPT. SHIRT', 'price': 500, 'image': 'dept_shirt.html.jpg'},
    'middle_product': {'name': '', 'price': 0, 'image': 'BSIT.jpg'},
    'uniform': {'name': 'UNIFORM', 'price': 900, 'image': 'uniform.jpg'},
    'polo': {'name': 'POLO', 'price': 400, 'image': 'polo.jpg'},
    'pants': {'name': 'PANTS', 'price': 300, 'image': 'pants.jpg'},
}
